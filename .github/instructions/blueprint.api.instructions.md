...
- `TarifasDeEnergiaBrasilApiClientError` (Base)
- `TarifasDeEnergiaBrasilApiClientCommunicationError` (Network, timeout, HTTP errors)
- `TarifasDeEnergiaBrasilApiClientAuthenticationError` (401, 403, invalid credentials)
