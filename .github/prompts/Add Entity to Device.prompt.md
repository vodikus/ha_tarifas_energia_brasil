...
- Inherit from `TarifasDeEnergiaBrasilEntity` and platform base class
...
- Entity: `custom_components/tarifas_energia_brasil/[platform]/[entity_name].py`
- Platform: `custom_components/tarifas_energia_brasil/[platform]/__init__.py`
