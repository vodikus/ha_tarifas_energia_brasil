...
- **Main code:** `custom_components/tarifas_energia_brasil/`
...
- `entity/` — Base entity class (`TarifasDeEnergiaBrasilEntity`)
...
- Entity MRO: `(PlatformEntity, TarifasDeEnergiaBrasilEntity)` — order matters
...
- Debug level: `custom_components.tarifas_energia_brasil: debug` in `config/configuration.yaml`
