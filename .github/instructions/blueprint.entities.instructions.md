...
- **`entity/`** - Base entity classes (inherit `TarifasDeEnergiaBrasilEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, TarifasDeEnergiaBrasilEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import TarifasDeEnergiaBrasilEntity`
