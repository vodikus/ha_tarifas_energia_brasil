...
- Create new sensor file in `custom_components/tarifas_energia_brasil/sensor/`
- Inherit from `TarifasDeEnergiaBrasilEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Tarifas de Energia Brasil."""
...
class TarifasDeEnergiaBrasil[SensorName]Sensor(
...
- Entity: `custom_components/tarifas_energia_brasil/sensor/[sensor_name].py`
- Platform: `custom_components/tarifas_energia_brasil/sensor/__init__.py`
- Translations: `custom_components/tarifas_energia_brasil/translations/*.json`
