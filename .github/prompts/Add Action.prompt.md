...
**File:** `custom_components/tarifas_energia_brasil/services.yaml`
...
[action_name]:
  ...
  target:
    entity:
      ...
      # OR
      integration: tarifas_energia_brasil
...
Create `custom_components/tarifas_energia_brasil/service_actions/[action_name].py`:

```python
"""[Action name] service action for Tarifas de Energia Brasil."""
...
**File:** `custom_components/tarifas_energia_brasil/__init__.py`
...
**File:** `custom_components/tarifas_energia_brasil/const.py`
...
3. Find service action: `tarifas_energia_brasil.[action_name]`
...
- **Service actions directory:** `custom_components/tarifas_energia_brasil/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/tarifas_energia_brasil/services.yaml` (legacy filename)
- **Icons:** `custom_components/tarifas_energia_brasil/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/tarifas_energia_brasil/translations/*.json` under `services` key (legacy)
